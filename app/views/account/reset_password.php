...
<div class="container" style="max-width: 500px; margin-top: 60px;">
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-4">
            ...
            <!-- ✅ DEBUG: Hiển thị token để kiểm tra -->
            <?php if (empty($token)): ?>
                <div class="alert alert-warning">
                    ⚠️ <strong>Token rỗng!</strong> Vui lòng click vào link từ email hoặc trang forgot-password.
                </div>
            <?php else: ?>
                <div class="alert alert-info small">
                    <strong>Token:</strong> <code><?= htmlspecialchars(substr($token, 0, 20)) ?>...</code>
                </div>
            <?php endif; ?>
            ...
            <div class="text-center mt-3">
                <a href="/account/login" class="text-decoration-none text-muted">
                    ← Quay lại đăng nhập
                </a>
            </div>
        </div>
